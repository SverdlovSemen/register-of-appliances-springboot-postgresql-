...
public class ModelControllerImpl<T> implements BaseController<T> {
    private final ModelService<T> modelService;
    private final ModelMapper modelMapper;
    private final ModelValidator modelValidator;

    @Autowired
    public ModelControllerImpl(ModelService modelService, ModelMapper modelMapper, ModelValidator modelValidator) {
    ...
    @ExceptionHandler
    public ResponseEntity<ModelErrorResponse> handleException(ModelNotFoundException e){
    ...
    @ExceptionHandler
    public ResponseEntity<ModelErrorResponse> handleException(ModelNotCreatedException e){
